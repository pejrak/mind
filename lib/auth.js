...
module.exports = function(MIND) {
  ...
  me.init = function(app) {
    ...
    passport.use(
      ...
      function(accessToken, refreshToken, profile, done) {
        ...
        LOG("accessToken, refreshToken:", accessToken, refreshToken)
    ...
    app.get('/auth/google/return',
      ...
      function(req, res) {
        ...
        LOG("return from google auth |req.isAuthenticated():", req.isAuthenticated())
  ...
  me.status = function(req, res, next) {
    var is_authenticated = req.isAuthenticated()
    LOG("status: is_authenticated, req.user:", is_authenticated, req.user)
  ...
  function checkUser(options, done) {
    ...
    user.loadRecord(email, function(errors, user_record) {
      LOG("checkUser | errors, user_record:", errors, user_record)
      ...
      if (done) {
        ...
        LOG("checkUser | redirect_to:", redirect_to)
